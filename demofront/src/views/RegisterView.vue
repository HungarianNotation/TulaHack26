...
<template>
  <div
    class="min-h-screen flex items-center justify-center bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-blue-100 via-gray-50 to-white px-4 py-10 relative overflow-hidden"
  >
    <!-- Декоративные элементы на фоне -->
    <div
      class="absolute -top-40 -right-40 w-96 h-96 bg-blue-400 rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-blob"
    ></div>
    <div
      class="absolute -bottom-40 -left-40 w-96 h-96 bg-indigo-400 rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-blob animation-delay-2000"
    ></div>
    ...
    >
      ...
      <div class="text-center mb-8">
        ...
        <p class="text-gray-500 mt-2 text-sm">
          Присоединяйтесь к системе VoiceRedactor
        </p>
      </div>
