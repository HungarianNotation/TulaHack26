...
export default function LoginPage() {
    ...
    return (
        <>
        <div className="relative z-20 min-h-screen flex items-center justify-center p-4 pointer-events-none">
            <div
            className="card w-full max-w-md bg-custom-bg-secondary shadow-lg pointer-events-auto"
            ...
            <div className="card-body p-8">
                ...
                Нет аккаунта?{' '}
                <a href="/register" className="text-custom-accent hover:underline">
                    Зарегистрироваться
                </a>
                </div>
            </div>
